...
from ZeMusic.core.errors import capture_err
from ZeMusic.core.keyboard import ikb
from ZeMusic.utils.dbfunctions import (
    add_warn,
    get_warn,
    int_to_alpha,
    remove_warns,
...
from ZeMusic.utils.functions import (
    extract_user,
...
from ZeMusic.core.permissions import adminsOnly
admins_in_chat = {}
...
async def kickFunc(_, message: Message):
    ...
    msg = f"""
**Kicked User:** {mention}
**Kicked By:** {message.from_user.mention if message.from_user else 'Mody'}
...
async def banFunc(_, message: Message):
    ...
    msg = (
        ...
        f"**Banned By:** {message.from_user.mention if message.from_user else 'Mody'}\n"
    )
    if message.command[0][0] == "d":
        await message.reply_to_message.delete()
...
async def mute(_, message: Message):
    ...
    msg = (
        ...
        f"**Muted By:** {message.from_user.mention if message.from_user else 'Mody'}\n"
    )
...
async def warn_user(_, message: Message):
    ...
    if warns >= 2:
        ...
        msg = f"""
**حذرت :** {mention}
**يا:** {message.from_user.mention if message.from_user else 'Mody'}
